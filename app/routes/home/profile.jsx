...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      With a strong design sense and solid prototyping skills, I bridge the gap between
      design and development to deliver pixel-perfect, maintainable solutions.
    </Text>
  </Fragment>
);
